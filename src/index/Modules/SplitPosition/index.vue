<template>
  <div class="drawer-box">
    <ul>
      <!-- <li>
        <div class="title">选择需要按位置拆分的列</div>
        <div class="content">
...
import { reqSplitPosition } from "../../api";
import SelectColumn from "../../components/SelectColumn/index";
import { splitPosition } from "../../utils/processing";
export default {
